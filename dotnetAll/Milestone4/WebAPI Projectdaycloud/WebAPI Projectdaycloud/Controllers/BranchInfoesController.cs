...
namespace WebAPI_Projectdaycloud.Controllers
{
    ...
    [ApiController]
    public class BranchInfoesController : ControllerBase
    {
        private readonly AsmitakumariBankingDbContext _context;

        public BranchInfoesController(AsmitakumariBankingDbContext context)
        {
            _context = context;
        }

        // GET: api/BranchInfoes
        [HttpGet]
        ...
        public async Task<ActionResult<BranchInfo>> PostBranchInfo(BranchInfo branchInfo)
        {
          if (_context.BranchInfos == null)
          {
              return Problem("Entity set 'AsmitakumariBankingDbContext.BranchInfos'  is null.");
          }
