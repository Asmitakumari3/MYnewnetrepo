...
namespace Milestone4Q1WebApplication1.Controllers
{
    ...
    public class CustomersController : ControllerBase
    {
        ...
        public CustomersController(ProductsDbApiContext context)
        {
            _context = context;
        }
        ...
        public async Task<ActionResult<Customer>> PostCustomer(Customer customer)
        {
          if (_context.Customers == null)
          {
              return Problem("Entity set 'ProductsDbApiContext.Customers'  is null.");
          }
