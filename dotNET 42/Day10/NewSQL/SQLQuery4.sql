create database bankingDatabase1
	...
	create table employeeInfo(empNo int,
		...
		alter table employeeInfo add constraint chk_empDesignation_list2 check (empDesignation in ('Developer','Manager'))
		...
		--4. select with concatination / form a redable statement
			select empName + ' is a ' + empDesignation from EmployeeInfo
