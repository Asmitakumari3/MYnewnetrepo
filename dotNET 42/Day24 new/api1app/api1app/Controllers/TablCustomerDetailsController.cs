...
namespace api1app.Controllers
{
    ...
    [ApiController]
    public class TablCustomerDetailsController : ControllerBase
    {
        private readonly ShopingDbApiContext _context;

        public TablCustomerDetailsController(ShopingDbApiContext context)
        {
            _context = context;
        }

        // GET: api/TablCustomerDetails
        [HttpGet]
        ...
        // DELETE: api/TablCustomerDetails/5
        [HttpDelete("{id}")]
